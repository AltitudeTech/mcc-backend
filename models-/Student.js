...
// Student.schema.set('usePushEach', true);
...
// }, 'verification', {
// 	documentsUploaded: { type: Types.Relationship, ref: 'StudentDocument', many: true },
// 	//documents: { type: Types.Relationship, ref: 'StudentDocument', many: true },
// }
);

// Virtuals
// Student.schema.virtual('isTested').get(() => {
// 	if (this.result.seeker || this.result.startup)
// 		return true;
// 	return false;
// });
// Student.schema.virtual('testTaken').get(() => {
// 	if (this.result.seeker && this.result.startup)
// 		return 'both';
...
Student.schema.post('save', function () {
	if (this.wasNew) {
...
// Methods
Student.schema.methods.sendActivationLink = function (callback) {
	if (this.isActivated) {
 ...
 * Registration
 */
Student.defaultColumns = 'name, phone, email';
Student.register();
